...
class ModalFactory {
    ...
    setPhotographernameInfo() {
        const sectionDOM = this.modal.querySelector('h3')
        sectionDOM.textContent = this.getPhotographernameInfo()
    }

    getPhotographernameInfo () {
    ...
    submitForm (e) {
        ...
        console.log('ContactForm :', inputDatas.join(' ; '))
        this.closeModal()
        this.form.reset()
    }
